...
### Behoben
- Weißer Bildschirm im Chatbereich nach App-Updates: Der WebView wird nach
  einem Renderer-Kill durch Android (Speicherdruck) automatisch neu erstellt,
  statt dauerhaft weiß zu bleiben. Betrifft Chat- und Embedded-WebView.

### Technisch
- GitHub-Actions-Workflow auf Node-24-kompatible Action-Versionen angehoben
  (checkout v5, setup-java v5, upload/download-artifact v6, gh-release v3).
